<template>
  <div id="rules_panel">
    <el-dialog :visible.sync="eidtRuleStatus">
      <div slot="title">规则编辑</div>
    ...
    <div class="rules-list">
      <el-button type="primary" :plain="true" icon="el-icon-plus" @click="eidtRuleStatus = true">添加规则</el-button>
      <el-table :data="rulesData" border :row-class-name="tableRowClassName">
        ...
        <el-table-column label="Operating">
          <template slot-scope="scope">
            ...
            <el-button size="small" type="warning" @click="handleCurrentChange(scope.$index, scope.row)" v-if="currentSelectIndex === scope.$index">取消</el-button>
