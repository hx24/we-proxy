<template>
    <div id="mock">
        <div class="mock-project">
            ...
            <el-button type="primary" :plain="true" icon="el-icon-plus" @click="addProjectStatus = true">{{ $t("ap.mocklist.addbtn") }}</el-button>
        ...
        <div class="mock-path" v-if="currentProject.id">
            ...
            <el-button type="primary" :plain="true" icon="el-icon-plus" @click="toAddPath">{{ $t("ap.mocklist.addapibtn") }}</el-button>
            <el-table
